...
var file_openned8_proto_rawDesc = []byte{
	...
	0x69, 0x63, 0x65, 0x52, 0x65, 0x73, 0x70, 0x32, 0xe0, 0x09, 0x0a, 0x08, 0x6f, 0x70, 0x65, 0x6e,
	...
	0x69, 0x6e, 0x67, 0x12, 0x45, 0x0a, 0x0c, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x44, 0x65, 0x76,
	0x69, 0x63, 0x65, 0x12, 0x19, 0x2e, 0x6f, 0x70, 0x65, 0x6e, 0x6e, 0x65, 0x64, 0x38, 0x2e, 0x41,
	0x63, 0x74, 0x69, 0x76, 0x65, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x52, 0x65, 0x71, 0x1a, 0x1a,
	0x2e, 0x6f, 0x70, 0x65, 0x6e, 0x6e, 0x65, 0x64, 0x38, 0x2e, 0x41, 0x63, 0x74, 0x69, 0x76, 0x65,
	0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x52, 0x65, 0x73, 0x70, 0x42, 0x0c, 0x5a, 0x0a, 0x2e, 0x2f,
	0x6f, 0x70, 0x65, 0x6e, 0x6e, 0x65, 0x64, 0x38, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_openned8_proto_depIdxs = []int32{
	...
	35, // 27: openned8.openned8.activeDevice:input_type -> openned8.ActiveDeviceReq
	1,  // 28: openned8.openned8.initDatabase:output_type -> openned8.BaseMsg
	5,  // 29: openned8.openned8.appCreate:output_type -> openned8.AppInfo
	5,  // 30: openned8.openned8.appUpdate:output_type -> openned8.AppInfo
	1,  // 31: openned8.openned8.appDelete:output_type -> openned8.BaseMsg
	10, // 32: openned8.openned8.appQuery:output_type -> openned8.ApplistInfo
	11, // 33: openned8.openned8.categoryQuery:output_type -> openned8.CategorylistResp
	13, // 34: openned8.openned8.industryQuery:output_type -> openned8.IndustrylistResp
	17, // 35: openned8.openned8.activeCodeQuery:output_type -> openned8.ActiveCodeListInfo
	18, // 36: openned8.openned8.activeCodeCreat:output_type -> openned8.ActiveCodeResp
	31, // 37: openned8.openned8.downloadCodeByAppId:output_type -> openned8.DownloadCodeByAppIdResp
	27, // 38: openned8.openned8.sdkListQuery:output_type -> openned8.SdkListResp
	28, // 39: openned8.openned8.sdkQueryByApp:output_type -> openned8.AppSdkListResp
	25, // 40: openned8.openned8.appBindSdk:output_type -> openned8.AppSdkInfo
	4,  // 41: openned8.openned8.queryUserSdkUsage:output_type -> openned8.SdkUsage
	4,  // 42: openned8.openned8.updateUserSdkUsage:output_type -> openned8.SdkUsage
	24, // 43: openned8.openned8.createSdk:output_type -> openned8.SdkInfo
	34, // 44: openned8.openned8.querySdkKeyByAppIdAndActiveCode:output_type -> openned8.BaseString
	36, // 45: openned8.openned8.activeDevice:output_type -> openned8.ActiveDeviceResp
